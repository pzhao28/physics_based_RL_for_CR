...
class env():
    ...
    def step(self, action):
        ...
        for aircraft in self.aircrafts:
            ...
            if aircraft.x > max_x + 2*aircraft.radius or aircraft.x < 0 - 2*aircraft.radius or aircraft.y > max_y + 2*aircraft.radius or aircraft.y < 0 - 2*aircraft.radius:
                self.aircrafts.pop(self.aircrafts.index(aircraft))
                #reward += 1
