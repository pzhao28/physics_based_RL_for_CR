...
class testIntruderConfig:
    def __init__(self, vels=np.array([3.5, 3.8,  4.7, 4.7]),
                        starts = np.array([[0, 80.0], [40, 80.0], [0, 40.0], [80, 40.0]])
                        , ends = np.array([[80, 40.0], [40, 0.0], [80, 80.0], [0, 80.0]])
                        , steps = np.array([3, 32, 24, 13])):
